...
class RequestTest
{
    ...
    public function undefinedInput(Assert $assert) : void
    {
        ...
        $assert->whenCalled(() ==> {
            $req->get('a');
        })->willThrowClass(\HackPack\HackMini\Command\Exception\UndefinedInput::class);
    ...
    public function missingArgument(Assert $assert) : void
    {
        ...
        $assert->whenCalled(() ==> {
            $req->at('arg1');
        })->willThrowClass(\HackPack\HackMini\Command\Exception\MissingInput::class);
    }
    ...
    {
        $req = (new Request('', Vector{'value'}, '', $this->parser))
            ->withArguments(Vector{
                shape('name' => 'arg'),
            });
    ...
    {
        $req = (new Request('', Vector{'val1', 'val 2'}, '', $this->parser))
            ->withArguments(Vector{
                shape('name' => 'arg1'),
                shape('name' => 'arg2'),
            });
    ...
    public function argOptArg(Assert $assert) : void
    {
        $req = (new Request(
            ...
            ->withOptions(Vector{
                shape('name' => 'opt', 'value required' => false),
            });
    ...
    public function argOptValueArgMissing(Assert $assert) : void
    {
        $req = (new Request(
            ...
            ->withOptions(Vector{
                shape('name' => 'opt', 'value required' => true),
            });
    ...
    public function optionWithMissingValue1(Assert $assert) : void
    {
        ...
        $assert->whenCalled(() ==> {
            $req->withOptions(Vector{
                shape('name' => 'one', 'alias' => 'o', 'value required' => true),
            });
        })->willThrowClass(\HackPack\HackMini\Command\Exception\MissingValue::class);
    }
