...
Hack;
    ...
    $assert->string(Shapes::idx($service, 'function', ''))->is('factory');
    $assert->mixed(Shapes::idx($service, 'class'))->isNull();
    $assert->mixed(Shapes::idx($service, 'method'))->isNull();
  }
...
Hack;
    ...
    $assert->mixed(Shapes::idx($service, 'function'))->isNull();
    $assert->string(Shapes::idx($service, 'class', ''))->is('Service');
    $assert->string(Shapes::idx($service, 'method', ''))->is('factory');
  }
