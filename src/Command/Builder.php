...
Hack;
    ...
    private function renderOptions(\ConstVector<OptionDefinition> $definitions) : string
    {
    ...
    private function renderArguments(\ConstVector<ArgumentDefinition> $arguments) : string
    {
    ...
    private function renderHandler(ParsedDefinition $definition) : string
    {
        ...
        return Shapes::idx($definition, 'function') === null ?
